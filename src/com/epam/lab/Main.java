...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Enter number of tasks 1,2,3,4,5, 6 or 7:");
        ...
        if (task == 1) {
            ...
            System.out.println("Through reflection print those fields in the class that were annotate by this annotation.\n" +
            ...
            for (Field validateField : guest.getDeclaredFields()) {
                if (validateField.isAnnotationPresent(MyAnnotation.class)) {
        ...
        if (task == 4) {
            ...
            LinkedList<MyBook> books = new LinkedList<>();
            Class classBook = Class.forName("com.epam.lab.MyBook");
        ...
        if (task == 6) {
            ...
            Class<?> clazz = Class.forName("com.epam.lab.MyMultipleParameters");
    ...
    /**
     * Utility function to get string representation of a modifier by it's integer value.
     *
     * @param mod - value of modifier.
